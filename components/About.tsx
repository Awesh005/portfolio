      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
          ...
          >
            ...
            <div className="space-y-8 text-lg md:text-xl text-zinc-600 leading-relaxed max-w-2xl">
              <p>
              ...
              <p className="font-serif italic text-2xl md:text-3xl text-zinc-800">
            ...
            <div className="mt-16 flex flex-wrap gap-12">
               ...
               <div className="border-l border-zinc-200 pl-12">
          ...
          >
            ...
            <div className="relative p-12 bg-white border border-zinc-200 rounded-[3rem] shadow-2xl">
              ...
              <div className="space-y-12">
                {EDUCATION.map((edu, idx) => (
                  <motion.div 
                    ...
                    className="relative pl-8 border-l border-zinc-100"
                  >
                    <div className="absolute top-1.5 left-[-4.5px] w-2 h-2 rounded-full bg-indigo-500"></div>
                    <div className="flex justify-between items-start">
                      <div>
                        <h4 className="font-black text-zinc-900 leading-tight uppercase text-xs tracking-widest mb-2">{edu.degree}</h4>
